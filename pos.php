        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="glass-effect rounded-3xl p-6 shadow-2xl flex flex-col h-fit lg:sticky lg:top-8">
                ...
                <div class="border-t pt-4">
                    ...
                    <button onclick="checkout()" class="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-xl font-semibold text-lg hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl mb-3">
                        Checkout
                    </button>
                    <button onclick="cancelOrder()" class="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-3 rounded-xl font-semibold hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-xl mb-3">
                        Cancel Order
                    </button>
                    <a href="backend/signout.php" class="block w-full bg-gradient-to-r from-amber-700 to-amber-800 text-white py-3 rounded-xl font-semibold hover:from-amber-800 hover:to-amber-900 transition-all shadow-lg hover:shadow-xl text-center">
                        Logout
                    </a>
                </div>
            </div>
