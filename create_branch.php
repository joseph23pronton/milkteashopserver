...
<body id="page-top">
    ...
    <?php include "backend/nav.php" ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Branches</h1>
                    <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Create Branches</h6>
                        </div>
                        <div class="card-body">
                        <form action="backend/branch_creation.php" method="post">
                            <input type="hidden" name="channel_id">
                            
                            <div class="form-group">
                                <label for="branch_name">Branch Name</label>
                                <input type="text" class="form-control" maxlength="32" name="branch_name" id="branch_name" required>
                            </div>
